...
void main() {
  group('Mock Authentication', () {
    ...
    test('Create user should delegate to logIn function', () async {
      final badEmailUser =
          provider.createUser(email: 'foo@bar.com', password: 'asd');
      expect(badEmailUser,
...
class MockAuthProvider implements AuthProvider {
  ...
  Future<AuthUser> logIn({required String email, required String password}) {
    ...
    const user =
        AuthUser(id: 'my_id', email: "mock@gmail.com", isEmailVerified: false);
    _user = user;
  ...
  Future<void> sendEmailVerification() async {
    ...
    var newUser =
        AuthUser(id: 'my_id', isEmailVerified: true, email: user.email);
    _user = newUser;
  }
}
